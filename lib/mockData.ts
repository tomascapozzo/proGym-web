...
export const MOCK_EVENTS: CalendarEvent[] = [
  { id: "e1",  type: "entrenamiento", title: "Entrenamiento táctico",    description: "Trabajo de línea de ventaja", startsAt: iso(5,  9,  0), endsAt: iso(5, 11, 0), opponent: null, location: null, groupIds: ["s1", "s2"], recurrence: null },
  { id: "e2",  type: "entrenamiento", title: "Físico y fuerza",          description: null,                          startsAt: iso(7,  8,  0), endsAt: iso(7,  9, 30), opponent: null, location: null, groupIds: ["s3"],       recurrence: null },
  { id: "e3",  type: "partido",       title: "vs Club San Isidro",       description: "Torneo del Interior",         startsAt: iso(10, 15, 0), endsAt: iso(10, 17, 0), opponent: "Club San Isidro", location: "local",     groupIds: ["s1"],       recurrence: null },
  { id: "e4",  type: "entrenamiento", title: "Lineout y scrum",          description: null,                          startsAt: iso(12, 9,  0), endsAt: iso(12, 11, 0), opponent: null, location: null, groupIds: ["s1", "s2"], recurrence: null },
  { id: "e5",  type: "entrenamiento", title: "Velocidad y agilidad",     description: null,                          startsAt: iso(14, 8,  0), endsAt: iso(14,  9, 0), opponent: null, location: null, groupIds: ["s4"],       recurrence: null },
  { id: "e6",  type: "partido",       title: "vs Hindú Club",            description: null,                          startsAt: iso(17, 15, 30), endsAt: iso(17, 17, 30), opponent: "Hindú Club", location: "visitante",  groupIds: ["s2"],       recurrence: null },
  { id: "e7",  type: "entrenamiento", title: "Entrenamiento de ataque",  description: "Trabajo de backline",         startsAt: iso(19, 9,  0), endsAt: iso(19, 11, 0), opponent: null, location: null, groupIds: ["s1"],       recurrence: null },
  { id: "e8",  type: "entrenamiento", title: "Física general",           description: null,                          startsAt: iso(21, 8,  0), endsAt: iso(21,  9, 30), opponent: null, location: null, groupIds: ["s1", "s2", "s3"], recurrence: null },
  { id: "e9",  type: "partido",       title: "vs Alumni AC",             description: "Torneo del Interior - Fecha 3", startsAt: iso(24, 15, 0), endsAt: iso(24, 17, 0), opponent: "Alumni AC", location: "local",     groupIds: ["s1"],       recurrence: null },
  { id: "e10", type: "entrenamiento", title: "Recuperación activa",      description: null,                          startsAt: iso(26, 9,  0), endsAt: iso(26, 10, 30), opponent: null, location: null, groupIds: ["s1", "s2"], recurrence: null },
  { id: "e11", type: "partido",       title: "vs Los Matreros",          description: null,                          startsAt: iso(31, 14, 0), endsAt: iso(31, 16, 0), opponent: "Los Matreros", location: "visitante", groupIds: ["s3"],       recurrence: null },
  // A few in April and June for edge cases
  { id: "e12", type: "entrenamiento", title: "Pretemporada",             description: null,                          startsAt: new Date(y, 3, 28, 9, 0).toISOString(), endsAt: new Date(y, 3, 28, 11, 0).toISOString(), opponent: null, location: null, groupIds: ["s1"], recurrence: null },
  { id: "e13", type: "entrenamiento", title: "Primer entrenamiento",     description: null,                          startsAt: new Date(y, 5,  3, 9, 0).toISOString(), endsAt: new Date(y, 5,  3, 11, 0).toISOString(), opponent: null, location: null, groupIds: ["s2"], recurrence: null },
];
