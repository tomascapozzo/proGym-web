      ...
      <div style={{ width: "100%", maxWidth: 380, position: "relative" }}>
        ...
        <div style={{ background: "var(--pg-card)", border: "1px solid var(--pg-border)", borderRadius: 16, padding: "2rem" }}>
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            <div>
              <label style={{ fontSize: "0.8rem", fontWeight: 600, color: "var(--pg-muted)", display: "block", marginBottom: 6 }}>Nombre</label>
              <input
                type="text"
                value={name}
        ...
        <p style={{ textAlign: "center", fontSize: "0.82rem", color: "var(--pg-muted)", marginTop: "1.25rem" }}>
          ¿Ya tenés cuenta?{" "}
          <Link href="/auth/login" style={{ color: "var(--pg-accent)", textDecoration: "none", fontWeight: 600 }}>
            Ingresar
          </Link>
        </p>
      </div>
